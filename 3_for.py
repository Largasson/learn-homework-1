...
def main():
    ...
    for product_dict in lst:
        ...
        res += temp
        res_of_length += length_of_seq

    medieval_length = res_of_length / len(lst)
    print(f'Суммарное количество продаж всех смартфонов: {res}')
    print(f'Ссреднее количество продаж всех смартфонов: {round(res / medieval_length)}')
